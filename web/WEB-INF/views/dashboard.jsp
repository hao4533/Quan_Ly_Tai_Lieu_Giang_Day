...
<%
    ...
    String fullName = (currentUser != null) ? currentUser.getFullName() : "Người dùng";
%>
<!DOCTYPE html>
<html lang="vi">
    <head>
...
<!--                        <li class="menu-item">
            ...
            <main class="content-container">
                <h2 class="content-title">Dữ liệu</h2>

                <div class="section-title">Thư mục</div>
                <div class="grid-container">
                    <div class="folder-card">
                        <i class="bi bi-folder-fill" style="color: #f4b400;"></i>
                        <span>Bài giảng Kì 1</span>
                    </div>
                    <div class="folder-card">
                        <i class="bi bi-folder-fill" style="color: #f4b400;"></i>
                        <span>Đề thi & Đáp án</span>
                    </div>
                    <div class="folder-card">
                        <i class="bi bi-folder-fill" style="color: #f4b400;"></i>
                        <span>Tài liệu chuyên ngành</span>
                    </div>
                </div>
                ...
                <div class="grid-container">
                    <div class="file-card">
                        ...
                        <div class="file-info">
                            <span>Giaoan_Toan_Lop10.docx</span>
                        </div>
                    </div>
                    <div class="file-card">
                        <div class="file-preview">
