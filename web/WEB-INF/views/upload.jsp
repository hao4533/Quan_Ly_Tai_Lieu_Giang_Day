...
<html lang="vi">
    ...
    <body>
        <div class="upload-container">
            ...
            <form id="upload-form" action="${pageContext.request.contextPath}/documents" method="POST" enctype="multipart/form-data">
                ...
                <div class="action-area">
                    <button type="button" class="btn btn-cancel" onclick="window.location.href = 'dashboard'">Hủy bớt</button>
                ...
                xhr.onreadystatechange = function () {
                    if (xhr.readyState === XMLHttpRequest.DONE) {
                        if (xhr.status === 200) {
                            ...
                            uploadStatus.innerText = "Có lỗi xảy ra trong quá trình tải lên!";
                            submitBtn.disabled = false;
                        }
                    }
                };
