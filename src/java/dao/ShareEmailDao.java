...
public class ShareEmailDao extends BaseDao<ShareEmail> {

    // JNDI Name cấu hình Connection Pool trên Server (GlassFish/Payara)
    public ShareEmailDao() {
        super("jdbc/SharesDB");
    }

    @Override
    public List<ShareEmail> getAll() {
        List<ShareEmail> shares = new ArrayList<>();
        ...
        try (Connection conn = getConnection();
            ...
            System.getLogger(ShareEmailDao.class.getName()).log(System.Logger.Level.ERROR, "Lỗi getAll shares", ex);
        }
        return shares;
    }

    @Override
    public ShareEmail getById(int id) {
     ...
     */
    public ShareEmail getByToken(String token) {
        ...
        try (Connection conn = getConnection();
            ...
            System.getLogger(ShareEmailDao.class.getName()).log(System.Logger.Level.ERROR, "Lỗi getByToken", ex);
        }
        return null;
    }

    @Override
    public boolean insert(ShareEmail model) {
        ...
        try (Connection conn = getConnection();
            ...
            System.getLogger(ShareEmailDao.class.getName()).log(System.Logger.Level.ERROR, "Lỗi insert share", ex);
            return false; // Đã sửa: Trả về false khi xảy ra lỗi ngoài ý muốn!
        }
    }

    @Override
    public boolean update(ShareEmail model) {
        ...
        try (Connection conn = getConnection();
            ...
            System.getLogger(ShareEmailDao.class.getName()).log(System.Logger.Level.ERROR, "Lỗi update share", ex);
    ...
    public boolean deleteByToken(String token) {
        ...
        try (Connection conn = getConnection();
            ...
            System.getLogger(ShareEmailDao.class.getName()).log(System.Logger.Level.ERROR, "Lỗi deleteByToken", ex);
            return false;
        }
    }
     ...
     */
    private ShareEmail mapResultSetToShare(ResultSet rs) throws SQLException {
